...
namespace TheNight_JustBuy.Areas.Admin.Models
{
    public class UserModelForCreate
    {
        ...
        [StringLength(maximumLength: 50, MinimumLength = 3, ErrorMessage = "The first name must be between 3 and 20 characters long.")]
        public string FirstName { get; set; }
        [Required(AllowEmptyStrings = false, ErrorMessage = "Please enter a valid last name!")]
        [StringLength(maximumLength: 50, MinimumLength = 3, ErrorMessage = "The last name must be between 3 and 20 characters long.")]
        ...
        [StringLength(maximumLength: 255, MinimumLength = 8, ErrorMessage = "The credit card must be between 8 and 30 characters long.")]
