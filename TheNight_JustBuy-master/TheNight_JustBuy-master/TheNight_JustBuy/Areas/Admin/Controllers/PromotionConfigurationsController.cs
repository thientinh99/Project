...
namespace TheNight_JustBuy.Areas.Admin.Controllers
{
    ...
    public class PromotionConfigurationsController : BaseController
    {
        private JustBuyEntities db = new JustBuyEntities();

        // GET: Admin/PromotionConfigurations
        public ActionResult Index()
        {
            return View(db.Configurations.Where(c => c.ConfigName.Contains("promotion")).ToList());
        }

        // GET: Admin/PromotionConfigurations/Details/5
        ...
        // GET: Admin/PromotionConfigurations/Create
