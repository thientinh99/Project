...
namespace TheNight_JustBuy.Areas.Admin.Controllers
{
    ...
    public class NewProductConfigurationsController : BaseController
    {
        private JustBuyEntities db = new JustBuyEntities();

        // GET: Admin/NewProductConfigurations
        public ActionResult Index()
        {
            return View(db.Configurations.Where(c => c.ConfigName.Contains("newproduct")).ToList());
        }
