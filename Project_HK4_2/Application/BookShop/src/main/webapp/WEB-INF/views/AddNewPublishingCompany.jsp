...
<title>Add New Publishing Company</title>
...
<c:url var="addNew"
	value="/dashboard/publishingCompany/addNewPublishingCompany" />
			...
			<div class="app-main__outer">
				<div class="app-main__inner">
					...
					<div class="main-card card">
						<div class="card-body">
							<h5 class="card-title">Add Publishing Company</h5>
							<div class="container">
								<form class="form-group" method="post" action="">
									<div class="row ">
										<div class="col-sm-6">
											<input type="text" class="form-control" name="publishingName"
												id="name" placeholder="Name Publishing">
										</div>
										<div class="col-sm-6">
